...
public class ConfigDB {
 ...
 private String Database="db_apotek";
...
Tabel.setModel(new DefaultTableModel(isiTabel(SQL,jum), title));} catch (Exception e) {JOptionPane.showMessageDialog(null,"Maaf  Terjadi  Kesalahan    pada  bagian method tampilTabel : \n ["+e.toString() +"]");
}
...
public void aturLebarKolom (JTable tabel, int baris[]){
    try {
      ...
      public void simpanData (String SQL){
          ...
          st.execute (SQL);
          st.close ();
          JOptionPane.showMessageDialog(null, "Data beerhasil disimpan");
          }catch (Exception e){
...
} catch (Exception e) {JOptionPane.showMessageDialog(null,"Maaf  Terjadi  Kesalahan    pada  bagian method ubahData : \n ["+e.toString() +"]");
}
}
